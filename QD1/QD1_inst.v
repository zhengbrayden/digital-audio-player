	QD1 u0 (
		...
		.spi_master_spi_master_cs   (<connected-to-spi_master_spi_master_cs>),   //    spi_master.spi_master_cs
		.spi_master_spi_master_sclk (<connected-to-spi_master_spi_master_sclk>), //              .spi_master_sclk
		.spi_master_spi_master_mosi (<connected-to-spi_master_spi_master_mosi>), //              .spi_master_mosi
		.spi_master_spi_master_miso (<connected-to-spi_master_spi_master_miso>), //              .spi_master_miso
		.spi_master_spi_master_cd   (<connected-to-spi_master_spi_master_cd>),   //              .spi_master_cd
		.spi_master_spi_master_wp   (<connected-to-spi_master_spi_master_wp>),   //              .spi_master_wp
