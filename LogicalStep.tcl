...
if {$make_assignments} {
	...
	set_global_assignment -name VERILOG_FILE pb_n_filters.v
...
#	set_location_assignment PIN_28 -to leds[1] #this pin assignment must remain as commented out. The Fitter will auto-place this output pin on its own later on.
